...
const nameclear =
  /(?!NetEase Music)(套餐|到期|有效|剩余|版本|已用|过期|失联|测试|官方|官网|过滤掉\s*\d+\s*条(?:线路|节点)|建议[：:]\s*.*切换.*(?:线路|节点)|网址|备用|群|TEST|客服|网站|获取|订阅|流量|机场|下次|官址|联系|邮箱|工单|学术|USE|USED|TOTAL|EXPIRE|EMAIL)/i;
// prettier-ignore
